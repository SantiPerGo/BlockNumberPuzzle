...
function drawButtons()
{
	...
	$("body").append('<div id="movBot"><input id="reiniciar" class="reiniciar" type="button" value="Reiniciar" /><div id="talking_boxm" class="texto2">Movimientos<br>0</div></div>');
	$("body").append('<div id="movBot" class="cronometro"><div id="hms"></div></div>');
}
	...
	$(".game_piece").click(function(){	
		...
		if(game.movePiece(piece_number)){
			if(localStorage.getItem("tamTablero") == "3x3"){
				...
				$(this).animate({'top':((game.piecesArray[piece_number-1].posX-1)*25)+'%','left':((game.piecesArray[piece_number-1].posY-1)*25)+'%'},540);	
			}
